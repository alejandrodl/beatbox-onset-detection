...
modes = ['RNN_1','RNN_2','RNN_3','RNN_4','RNN_5','RNN_6']
...
for mode in modes:
    ...
    for a in range(5):
        ...
        for train_index, test_index in skf.split(Tensor_TrainVal_Reduced, Classes_TrainVal_Reduced):
            ...
            early_stopping = tf.keras.callbacks.EarlyStopping(monitor='val_loss', min_delta=0.00001, patience=patience_early, verbose=2, mode='auto', baseline=None, restore_best_weights=True)
